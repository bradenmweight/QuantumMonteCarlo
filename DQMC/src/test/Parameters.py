...
def get_Parameters( ARGS ):
    ...
    # For equilibration
    PARAM["num_steps_equilibration"] = 2000
    PARAM["time_step_equilibration"] = 0.01 # Choose such that: num_steps * time_step > 5
    PARAM["alpha_equilibration"] = 0.1 # PARAM["time_step_equilibration"]
    # For production
    PARAM["num_steps_production"] = 1000
